...
export default function RovoChatbot() {
  ...
  const [messages, setMessages] = useState([
    { sender: 'rovo', text: 'Hi! I am Rovo, your APNILEAP Copilot. Ask me anything about Jira boards, Confluence wikis, project statuses, or meeting schedules!' }
  ]);
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { sender: 'rovo', text: 'Failed to communicate with Rovo engine. Make sure the database is running.' }]);
    } finally {
      setLoading(false);
    }
  };
      ...
      {isOpen && (
        <div style={{
          ...
          <div style={{
            ...
            <span>🤖 Atlassian Rovo Copilot</span>
          ...
          <form onSubmit={handleSend} style={{ padding: '12px', borderTop: '1px solid rgba(255, 255, 255, 0.08)', display: 'flex', gap: '8px' }}>
            <input
              ...
              placeholder="Ask Rovo to query status or meetings..."
              style={{
                flex: 1,

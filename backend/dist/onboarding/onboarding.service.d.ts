...
export declare class OnboardingService {
    ...
    private readonly bookstackService;
    private readonly n8nService;
    private readonly auditService;
    constructor(prisma: PrismaService, authService: AuthService, gitlabService: GitlabService, bookstackService: BookstackService, n8nService: N8nService, auditService: AuditService);
    register(data: {
        companyName: string;
        email: string;
        subdomain: string;
